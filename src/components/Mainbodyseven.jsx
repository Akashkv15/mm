...
function Mainbodyseven() {
  return (
    ...
    <div className='basebody d-flex flex-column flex-md-row justify-content-center   gap-3 gap-md-5  ' style={{backgroundColor:'#05155dff'}}>
        <div className='div1 d-flex flex-column align-items-start ' >
        ...
        <div className='div2 d-flex flex-column align-items-start'>
         ...
         <div className='div3 d-flex flex-column align-items-start'>
        ...
        <div className='div4 d-flex flex-column align-items-start'>
